...
#ENDTRIM -----------------------------------------------------           
    ...
    warningColorA: bpy.props.FloatVectorProperty(name='Warning color A', description='', default=(1.0, 0.3, 0.3, 0.05), subtype='COLOR', size=4)
    warningColorB: bpy.props.FloatVectorProperty(name='Warning Color B', description='', default=(0.8, 0.0, 0.0, 0.02), subtype='COLOR', size=4)
